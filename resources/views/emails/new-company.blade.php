...
<head>
    ...
    {{--    <link rel="stylesheet" href="{{asset('css/new-company/style.css')}}">--}}
</head>
...
<div class="container">
    ...
    <div class="dividered-section">
        ...
        <div class="app-row">
            <div class="app-store">
                <a href="#" title="App Store"><img src="{{asset('images/new-company/app-store.svg')}}" alt="App Store"></a>
            </div>
            <div class="google-play">
                <a href="#" title="Google play"><img src="{{asset('images/new-company/google-play.svg')}}" alt="Google play"></a>
            </div>
        </div>
        <div class="divider"></div>
        <div class="footer">
